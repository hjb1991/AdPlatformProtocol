...
| disclk      | int | 防误点开关 0：关闭，1：开启，2：WiFi时关闭 |
| name      | string | 应用名/广告名 |
| pn      | string | 应用包名 |
| siu      | string | 应用图标，选填 |
...
### 通知栏请求
>http://domain/notify/req?i={appid}&s=xxxxxxxxxxxxxxxxxxxx  

### 通知栏效果记录
>http://domain/notify/eff?i=xxxxxxxxxxxx&s=xxxxxxxxxxxxxxxxxxxx&e=e&pdt=1;
